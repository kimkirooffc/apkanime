...
public class StreamInfo {
    ...
    public StreamInfo(String title, String episodeSlug, List<String> streamingUrls,
                      Map<String, List<String>> downloadUrls, String prevEpisodeSlug,
                      String nextEpisodeSlug, String animeSlug) {
        this.title = title;
        this.episodeSlug = episodeSlug;
        this.streamingUrls = streamingUrls != null ? streamingUrls : new ArrayList<>();
        this.downloadUrls = downloadUrls != null ? downloadUrls : Collections.emptyMap();
    ...
    public List<String> getStreamingUrls() { return streamingUrls; }
    public Map<String, List<String>> getDownloadUrls() { return downloadUrls; }
    public String getPrevEpisodeSlug() { return prevEpisodeSlug; }
    public String getNextEpisodeSlug() { return nextEpisodeSlug; }
